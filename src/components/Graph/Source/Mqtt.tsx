  ...
  return (
    <div className="rounded-xl border bg-card text-card-foreground shadow w-60">
      <div className="flex flex-col space-y-1 p-2">
        <div className="font-semibold tracking-tight text-xs">MQTT</div>
        <div className="text-muted-foreground text-[0.5rem]/[0.7rem]">
          eKuiper为MQTT源流提供了内置支持,流可以订阅来自MQTT代理的消息并输入eKuiper处理管道。
        </div>
      </div>
      <div className="p-0">
            ...
            <DialogContent className="sm:max-w-[40vw] md:max-w-[40vw]">
              <DialogHeader>
                ...
                <DialogDescription>
                  ...
                  Transport）是一种轻量级的通信协议，用于在物联网设备之间进行可靠的消息传递。eKuiper
                  内置 MQTT 连接器，方便订阅来自 MQTT 代理的消息并输入 eKuiper
                  处理管道，实现对指定 MQTT 主题的实时数据处理。 在 eKuiper
                  中，MQTT 连接器可以作为源连接器（从 MQTT 代理获取数据）或 Sink
                  连接器（将数据发布到 MQTT 代理），本节重点介绍 MQTT 源连接器。
                </DialogDescription>
              </DialogHeader>
